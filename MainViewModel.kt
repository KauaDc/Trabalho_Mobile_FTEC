...
class MainViewModel(private val app: Application, private val db: AppDatabase) : AndroidViewModel(app) {
    ...
    private val _answeringFor = MutableStateFlow("self") // "self" ou "other"
    val answeringFor: StateFlow<String> = _answeringFor

    fun setAnsweringFor(value: String) {
        _answeringFor.value = value
    }
